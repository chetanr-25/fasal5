 ...
 */
const fetchFromENAM = async (cropName: string): Promise<MarketPriceData[]> => {
  try {
 ...
 */
const fetchFromCEDA = async (cropName: string): Promise<MarketPriceData[]> => {
  try {
    ...
    const mockData: MarketPriceData[] = [
      {
        crop_name: cropName,
 ...
 */
const fetchFromWebScraping = async (cropName: string): Promise<MarketPriceData[]> => {
  try {
 ...
 */
export const getMarketPriceForCrop = async (cropName: string, state?: string, district?: string): Promise<MarketPriceData[]> => {
  try {
    ...
    let marketPrices: MarketPriceData[] = [];
 ...
 */
export const getCurrentMarketPrice = async (cropName: string): Promise<number> => {
  try {
    const prices = await getMarketPriceForCrop(cropName);
